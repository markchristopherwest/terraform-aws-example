...
storage "raft" {
  ...
  retry_join {
    auto_join = "provider=aws addr_type=public_v4 tag_key=cluster_name tag_value=raft-test region=${aws_region}"
...
%{ if tpl_vault_node_name == "vault_0" }
# vault_0 adds some test data to demonstrate that the cluster is connected to
#   the same data.
sleep 5
